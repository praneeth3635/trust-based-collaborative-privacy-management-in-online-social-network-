...
<head>
<title>Shared & Non Shared Posts Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"><span class="style3">All Shared Posts with Votes and Reviews..</span></h2>
          <div class="clr"></div>
...
<%
      	...
      	try 
	{
      		...
      		String query="select * from posts where pshare='"+"Shared"+"' "; 
    ...
    <td><div align="center" style="color:#000000"><%=s2%></div></td>
     <td><div align="center" style="color:#000000"><%=decryptedDes%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><%=s7%></div></td>
		  	   <td><div align="center"><a href="Admin_Viewreviews.jsp?pname=<%= s1%>&upname=<%=s8%>" class="style8">Reviews</a></div></td>
  </tr>
...
%>
			...
			<p>&nbsp;</p>
			<h2 align="center"><span class="style3">All Non Shared Posts with Votes and Reviews..</span></h2>
			<p align="center">&nbsp;</p>
			<table width="600" border="1" align="center">
  <tr>
   <td width="19" height="32"><div align="center" style="color:#660000"><b>Id</b> </div></td>
    ...
    <td><div align="center" style="color:#000000"><%=s12%></div></td>
     <td><div align="center" style="color:#000000"><%=decryptedDes1%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><%=s17%></div></td>
		  	   <td><div align="center"><a href="Admin_Viewreviews.jsp?pname=<%= s11%>&upname=<%=s18%>" class="style8">Reviews</a></div></td>
