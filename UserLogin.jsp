...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="left"><a href="index.html"><span class="style3">Welcome To User Login..</span></a></h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p><img src="images/Login.png" width="158" height="158" /></p>
            <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
					...
					<table width="464" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        <td height="40" align="justify"><span class="style34 style5">Password (required)</span></td>
                      ...
                      <tr>
                        ...
                        <td><span class="style16">
                          ...
                          <strong> New User?</strong></span><a href="UserRegister.jsp" class="style30 style6"> Register </a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
