...
<head>
<title>Friends Video Post Page</title>
		  ...
		  <%
            ...
            <table width="511" border="1" align="center"  cellpadding="0" cellspacing="0"  >
               <tr bgcolor="#FFFFFF">
                 ...
                 <td  width="96" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660000;"><div align="center" class="style2" > <b>Post Video</b> </div></td>
               ...
               <%
					  ...
					  int i=1,j=0,count=0;
						...
						try 
						{
						   	...
						   	String query="select * from video_posts where uname='"+fname+"' and pshare='"+"Shared"+"' "; 
               ...
               <tr>
                 ...
                 <td width="96" valign="middle" bgcolor="#FFFFFF">
                     <video controls preload="auto" src="./<%=s4%>" width="150" height="150"></video><div align="center"><%=s4%>
                 </div></td>
                 <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style7"  >
                 ...
                 <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style9" ><strong> <a href="User_VReview.jsp?id=<%=j%>&amp;pname=<%=s0%>&fname=<%=fname%>&upname=<%=s1%>">Review</a> </strong></div></td>
				 <td height="0"  valign="middle" bgcolor="#FFFFFF">
			   <a href="User_VideoPostVote.jsp?pname=<%=s0%>&uname=<%=s1%>"><input name="vote" type="button" value="Vote" /></a></td>
               </tr>
               <%
					i=i+1;	
               ...
               <tr bgcolor="#FFFFFF">
                 ...
                 <td  width="76" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #660000;"><div align="center" class="style2" > <b>Post Video</b> </div></td>
               ...
               <tr>
                 ...
                 <td width="76" valign="middle" bgcolor="#FFFFFF">
                     <video controls preload="auto" src="./<%=s4%>" width="150" height="150"></video><div align="center"><%=s4%></div>
                 </td>
                 <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style7"  >
                     <div align="center" style="color:#006633"> 
                       <b><%out.println(s0);%></b>
               ...
               <tr>
                 ...
                 <td width="76" valign="middle" bgcolor="#FFFFFF">
				 <video controls preload="auto" src="./<%=s6%>" width="150" height="150"></video><div align="center"><%=s6%></div>
				 </td>
                 <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style7"  >
                     <div align="center" style="color:#006633">
                       <b><%out.println(s0);%></b>
			...
			%>
             ...
             <p>&nbsp;</p>
		<div align="right" class="style22"><a href="User_AllFriendsVideoPosts.jsp" class="style11">Back</a></div>
