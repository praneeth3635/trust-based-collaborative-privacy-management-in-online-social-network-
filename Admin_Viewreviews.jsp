...
<head>
<title>View Post Reviews Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="left"><a href="index.html"><span class="style3">Reviews on Post <%=request.getParameter("pname") %>..</span></a></h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
			...
			<div align="left" class="style8" style="margin-left:20px;"><b>Date</b></div></td>
					...
					<%
						...
						try 
						{
							String sql="select * from reviews where pname='"+pname+"' and uploader='"+upname+"' ";
...
<%					
					...
					%>
							...
							<p align="right"><a href="Admin_ViewSrNsrPosts.jsp" class="style16">Back</a></p>
