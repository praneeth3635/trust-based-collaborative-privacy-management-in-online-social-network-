        ...
        <div class="article">
		  ...
		  <p>&nbsp;</p>
            <table width="545" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      <tr>
                        <td  width="52"  valign="middle" height="34" style="color: #660000;"><div align="center" class="style2"><b>Si No. </b></div></td>
                        <td  width="176" valign="middle" height="34" style="color: #660000;"><div align="center" class="style2"><b>Image</b></div></td>
                        <td  width="180" valign="middle" style="color: #660000;"><div align="center" class="style2"><b>Name</b></div></td>
							...
							String user=(String)application.getAttribute("uname");
					   		...
					   		while ( rs.next() )
					   		{
									...
									if(rs9.next()==true)
									{
												...
												%>
                      <tr>
                        <td height="172" align="center"  valign="middle"><div align="center" class="style7"><b>
                            <%out.println(j);%>
                        </b></div></td>
                        <td width="176" rowspan="1" align="center" valign="middle" ><div class="style5" style="margin:10px 13px 10px 13px;" ><b>
