...
<head>
<title>All Video Posts Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="left"><a href="index.html"><span class="style3">User <%=(String)application.getAttribute("uname") %>'s All Video Posts..</span></a></h2>
          <div class="clr"></div>
...
<%
      	...
      	try 
	{
      		...
      		String query="select * from video_posts where uname='"+user+"' "; 
    ...
    <td><div align="center" style="color:#000000"><%=s2%></div></td>
     <td><div align="center" style="color:#000000"><%=decryptedDes%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><%=s7%></div></td>
		  	   <td><div align="center"><a href="User_ViewVreviews.jsp?pname=<%= s1%>" class="style8">Reviews</a></div></td>
			   <%if(s9.equalsIgnoreCase("Share")){%>
			   <td><div align="center"><a href="User_VpShare.jsp?pname=<%= s1%>" title="Click to Share with Friends" class="style7">Share</a></div></td>
			   <%}else{%>
