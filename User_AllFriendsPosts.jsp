...
<head>
<title>>User All Friends Posts Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="left"><a href="index.html"><span class="style3">View all Friends Posts..</span></a></h2>
          <div class="clr"></div>
               ...
               <%
					  ...
					  int i=1,j=0,count=0;
						...
						try 
						{
						   	...
						   	String query="select distinct(uname) from posts where uname!='"+uname+"' and pshare='"+"Shared"+"' "; 
		...
		String str1="select * from frequest where ((requestfrom='"+s3+"'&&requestto='"+uname+"') || (requestfrom='"+uname+"'&&requestto='"+s3+"'))&& status='Accepted'"; 
               ...
               <tr>
                 ...
                 <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" title="Click to View <%=s3%>'s Post"   class="style9" ><strong> <a href="User_ViewFriendsPost.jsp?fname=<%=s3%>" style="color:#006633">View Posts</a> </strong></div></td>
               </tr>
               <%
					i=i+1;	
