...
<head>
<title>Video Posts Vote In Chart Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"><a href="index.html"><span class="style3">All Video Posts Vote In Chart..</span></a></h2>
          <div class="clr"></div>
          <div class="post_content">
		  <p>&nbsp;</p>
            
            
			<iframe width="650" height="350" src="Admin_ViewVideoPostVoteInChart1.jsp"></iframe>
			      <div align="center" class="style11 style2 style5">(All Video Posts Name)</div>
				    <p>&nbsp;</p>
