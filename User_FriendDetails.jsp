...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="left"><a href="index.html"><span class="style3">Friend <%=request.getParameter("friendname") %>'s Profile..</span></a></h2>
          <div class="clr"></div>
		  ...
		  <p>&nbsp;</p>
            ...
            <%
				  ...
				  <p>&nbsp;</p>
				  <p align="right" class="style14"><a href="User_MyFriends.jsp" class="style13">Back</a></p>
