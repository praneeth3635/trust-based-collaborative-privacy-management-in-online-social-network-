...
<head>
<title>Trusted & Non Trusted Video Posts Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"><span class="style3">All Trusted Video Posts..</span></h2>
          <div class="clr"></div>
...
<%
      	...
      	try 
	{
      		...
      		String query="select * from video_posts where vote!="+0+" "; 
...
%>
			...
			<p>&nbsp;</p>	
			<h2 align="center"><span class="style3">All Non Trusted Video Posts..</span></h2>
			<p align="center">&nbsp;</p>
			<table width="600" border="1" align="center">
  <tr>
   <td width="19" height="32"><div align="center" style="color:#660000"><b>Id</b> </div></td>
