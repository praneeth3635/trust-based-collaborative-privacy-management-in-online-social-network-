...
<head>
<title>Review Status Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="left"><a href="index.html"><span class="style3">Review Status..</span></a></h2>
          <div class="clr"></div>
...
<span class="style4"> Reviewed Successfully...</span>
  <p align="right"><a href="User_ViewFriendsPost.jsp?fname=<%=fname%>" class="style47">Back</a></p>
                  <%
