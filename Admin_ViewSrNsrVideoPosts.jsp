...
<head>
<title>Shared & Non Shared Video Posts Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"><span class="style3">All Shared Video Posts with Votes and Reviews..</span></h2>
          <div class="clr"></div>
  ...
  <tr>
   ...
   <td width="100" height="32"><div align="center" style="color:#660000"><b>Video</b></div></td>
    ...
    <td width="66"><div align="center" style="color:#660000"><b>Post Description</b></div></td>
	  <td width="50"><div align="center" style="color:#660000"><b>Post Speciality</b></div></td>
...
<%
      	...
      	try 
	{
      		...
      		String query="select * from video_posts where pshare='"+"Shared"+"' "; 
  ...
  <tr>
    ...
    <td><div align="center" style="color:#CC0033"><b><%=s6%></b></div></td>
	<td><div align="center" style="color:#006633"><b><%=s1%></b></div></td>
    <td><video controls preload="auto" src="./<%=s8%>" width="150" height="150"></video><div align="center"><%=s8%></div>
	 </td>
    <td><div align="center" style="color:#000000"><%=s2%></div></td>
     <td><div align="center" style="color:#000000"><%=decryptedDes%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><b><%=v%></b></div></td>			   
		  	   <td><div align="center"><a href="Admin_ViewVreviews.jsp?pname=<%= s1%>&upname=<%=s6%>" class="style8">Reviews</a></div></td>
...
%>
			...
			<p>&nbsp;</p>	
			<h2 align="center"><span class="style3">All Non Shared Video Posts with Votes and Reviews..</span></h2>
			<p align="center">&nbsp;</p>
...
<%
  ...
  <tr>
    ...
    <td><div align="center" style="color:#CC0033"><b><%=s16%></b></div></td>
	<td><div align="center" style="color:#006633"><b><%=s11%></b></div></td>
    <td><video controls preload="auto" src="./<%=s18%>" width="150" height="150"></video><div align="center"><%=s18%></div>
	 </td>
    <td><div align="center" style="color:#000000"><%=s12%></div></td>
     <td><div align="center" style="color:#000000"><%=decryptedDes1%></div></td>
			   ...
			   <td><div align="center" style="color:#000000"><b><%=v1%></b></div></td>
		  	   <td><div align="center"><a href="Admin_ViewVreviews.jsp?pname=<%= s11%>&upname=<%=s16%>" class="style8">Reviews</a></div></td>
...
%>
			...
			<p class="style19">&nbsp;</p>
				  <p align="right"><a href="Admin_ViewSharedNonSharedPosts.jsp" class="style16">Back</a></p>
